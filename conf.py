...
BLOG_AUTHOR = "Raunak Mundada"  # (translatable)
BLOG_TITLE = "Experiments with Data"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://raunakm90.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://raunakm90.github.io/"
BLOG_EMAIL = "raunakm90@gmail.com"
BLOG_DESCRIPTION = "Collection of data exploration, statistical and machine learning techniques implementations."  # (translatable)
